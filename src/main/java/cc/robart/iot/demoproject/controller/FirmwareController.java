...
public class FirmwareController {
	...
	public Firmware add(@Valid @RequestBody Firmware firmware) {
	...
	@ResponseStatus(HttpStatus.OK)
	public Firmware update(@PathVariable String name, @RequestBody Firmware firmware) {
		return service.update(name,firmware);
	}
	
	@PostMapping(value="/assignFirmware/{name}",consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseStatus(HttpStatus.CREATED)
