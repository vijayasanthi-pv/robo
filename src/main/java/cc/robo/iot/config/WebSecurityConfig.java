...
import cc.robo.iot.utils.JwtAuthenticationEntryPoint;
import cc.robo.iot.utils.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		.antMatchers("/h2-console/**","/h2-console/login.do?jsessionid=**").permitAll()
		.antMatchers(
                HttpMethod.GET,
                "/",
                "/v2/api-docs",           // swagger
